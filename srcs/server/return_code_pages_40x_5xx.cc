...
void initialize_html_return_code_page(t_return_codes *return_codes)
{
	return_codes->ok_200 = "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<meta\
	 ...
	 <h1>The request was properly executed.</h1></body>\n</html>";
	return_codes->err_400 = "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<meta\
	 charset=\"UTF-8\">\n<title>400 Bad Request</title>\n</head>\n<body><h1>The\
	  request sent by the client (you) is probably malformed.</h1></body>\n</html>";
	return_codes->err_401 = "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<meta\
	 charset=\"UTF-8\">\n<title>401 Unauthorized</title>\n</head>\n<body><h1>You\
	  must authenticate.</h1></body>\n</html>";
	return_codes->err_403 = "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<meta\
	 charset=\"UTF-8\">\n<title>403 Forbidden</title>\n</head>\n<body><h1>\
	 Forbidden. Take a walk on the wild side</h1></body>\n</html>";
	return_codes->err_404 = "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<meta\
	 charset=\"UTF-8\">\n<title>404 Not Found</title>\n</head>\n<body><h1>The \
	 requested ressource is not found.</h1></body>\n</html>";
	return_codes->err_405 = "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<meta\
	 charset=\"UTF-8\">\n<title>405 Method Not Allowed</title>\n</head>\n<body><h1>\
	 The method you choose is not allowed here. :(</h1></body>\n</html>";
	return_codes->err_406 = "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<meta\
	 charset=\"UTF-8\">\n<title>406 Not Acceptable</title>\n</head>\n<body><h1>THIS\
	  ABSOLUTLY <br>NOT</br> ACCEPTABLE.</h1></body>\n</html>";
	return_codes->err_409 = "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<meta\
	 charset=\"UTF-8\">\n<title>409 Conflict</title>\n</head>\n<body><h1>Conflict\
	  in request.</h1></body>\n</html>";
	return_codes->err_408 = "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<meta\
	 charset=\"UTF-8\">\n<title>408 Request Timeout</title>\n</head>\n<body><h1>\
	 Time, It's a tick tock on the clock</h1></body>\n</html>";
	return_codes->err_409 = "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<meta\
	 charset=\"UTF-8\">\n<title>409 Conflict</title>\n</head>\n<body><h1>Conflict\
	  in request.</h1></body>\n</html>";
	return_codes->err_413 = "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<meta\
	 charset=\"UTF-8\">\n<title>413 Payload Too Large</title>\n</head>\n<body>\
	 <h1>(De)Enlarge your payload.</h1></body>\n</html>";
	return_codes->err_414 = "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<meta\
	 charset=\"UTF-8\">\n<title>414 URI Too Long</title>\n</head>\n<body><h1>\
	 Tooooooooooooooooooooooooooo loooooooooooooooooooooo..</h1></body>\n</html>";
	...
	return_codes->err_500 = "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<meta\
	 ...
	 <h1>The server encountered an error.</h1></body>\n</html>";
	return_codes->err_501 = "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<meta\
	 charset=\"UTF-8\">\n<title>501 Not Implemented</title>\n</head>\n<body><h1>\
	 The reauested method is not implemented/h1></body>\n</html>";
	return_codes->err_502 = "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<meta\
	 charset=\"UTF-8\">\n<title>502 Bad Gateway</title>\n</head>\n<body><h1>Bad \
	 Gateway</h1></body>\n</html>";
	return_codes->err_503 = "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<meta\
	 charset=\"UTF-8\">\n<title>503 Service Unavailable</title>\n</head>\n<body>\
	 <h1>Server is not ready to handle the request</h1></body>\n</html>";
	return_codes->err_504 = "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<meta\
	 charset=\"UTF-8\">\n<title>504 Gateway Timeout</title>\n</head>\n<body><h1>\
	 Time is gone</h1></body>\n</html>";
	return_codes->err_505 = "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<meta\
	 charset=\"UTF-8\">\n<title>505 HTTP Version Not Supported</title>\n</head>\n<b\
	 ody><h1>We only serve HTTP/1.1</h1></body>\n</html>";
